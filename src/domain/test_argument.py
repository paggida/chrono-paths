...
class TestArgument:
    ...
    def test_sets_the_attribute_when_receiving_the_option_to_move_the_files(self, valid_path):
    ...
    def test_invalidates_when_the_number_of_arguments_is_invalid(self, valid_path):
        ...
        invalid_path = os.path.dirname(fake.file_path(depth=3))
        test_argument_with_three_arguments = Argument(["", "-m", valid_path, invalid_path])
        ...
        assert test_argument_with_three_arguments.errors == 'Invalid number of arguments.'
